...
# XPaths:---------------------------------------------------------------------------------------------------- #
# Note: not all fields are used with each vendor, the minimum is user, pass, login
# xPath[0]: user field
# xPath[1]: pass field
# xPath[2]: logon button
# xPath[3]: file upload button
# xPath[4]: process changes button
radialXPath = ('//*[@id="Logon"]/form/table/tbody/tr[1]/td[2]/input', '//*[@id="Logon"]/form/table/tbody/tr[2]/td[2]/input', '//*[@id="Logon"]/form/table/tbody/tr[2]/td[5]/input', '/html/body/table/tbody/tr[3]/td[3]/table/tbody/tr[2]/td[2]/form/table/tbody/tr[4]/td[2]/input', '/html/body/table/tbody/tr[1]/td/table/tbody/tr[2]/td/table/tbody/tr/td[1]/table/tbody/tr/td[1]/a')
...
def ftpTransfer(file):
    ...
    FTP_SERVER = 'ECOSFTP.HSN.COM'
    FTP_PORT   = 22
    FTP_USER   = 'LDMCompany'
    FTP_PASS   = 'rEfmdKVPB@hD'
    
    try:
        cnopts = pysftp.CnOpts()
        cnopts.hostkeys = None
        server = pysftp.Connection(host=FTP_SERVER, username=FTP_USER, password=FTP_PASS, cnopts=cnopts)
        
        with server.cd('inventories'):
            server.put(localpath=file, remotepath=file, confirm=True)
...
def uploadFile(filePaths,        # path to file(s) to upload
               ...
               xPaths,           # xpaths to the various DOM elements: see xPaths section in globals
    ...
    try:
        ...
        for file in filePaths:
            ...
            if loginPage == loginComHub[0]:
                ...
                if xPaths[4] != '':
                    browser.find_element_by_xpath(xPaths[4]).click()
                if loginPage == loginRadial[0]:
...
def Main():
    ...
    numFilesUp += uploadFile((filePaths['Groupon']), loginGroupon[0], 'J632600@yahoo.com', '603550Duke2!', groupoXPath, loginGroupon[1], '//*[@id="logout"]', '//*[@id="file-browser"]')
